<template>
  <div>
    <div style="position: relative">
      <div class="step-item header-handle" v-handle>
        <div class="icon">
        ...
        <div class="info">
          ...
          <div class="hander">审核组：{{ item.handlerName }}</div>
          <div class="desc">描述：{{ item.description || '无'}}</div>
        </div>
      </div>
      <div class="handler-tool">
        <i class="gs-icon-edit" @click="$emit('edit-step')"></i>
        <i class="gs-icon-close" @click="$emit('del-step')"></i>
      </div>
    </div>
  </div>
</template>
